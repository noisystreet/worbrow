...
> 读者：项目维护者 / 贡献者。状态：**P1/P2 已落地（2026-08，P1 见 [roadmap.md](roadmap.md) ✅ 标记），P3 相关性门禁已落地（2026-08）**，随实施更新；落地决策按 AGENTS.md 记 ADR。
...
结果类型识别（`result_kind`）→ 质量降级信号 →（P2 同质化/同域名去重）→ P3 相关性门禁
